...
<html lang="lv">
  <head>
    ...
    <title class="navbar-brand" href="/login">Pedagogs</title>
  ...
  <body> @if(session('success')) @if(session('success') == true) <script>
    ...
    <div class="container">
      <table class="table">
        ...
        <tbody> @foreach($AudzeknisData as $ad) <tr>
            <td>
    ...
    <div class="container">
      <table class="table"> @if (session('LomaID') == 3) <thead>
    ...
    <div class="container">
      <table class="table"> @if (isset($ld) && $ld !== null && (session('LomaID') == 0 || session('LomaID') == 3)) <thead>

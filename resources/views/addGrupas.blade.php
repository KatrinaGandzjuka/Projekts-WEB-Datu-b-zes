...
<html lang="lv">
  ...
  <body>
    ...
    <!--forma-->
    <div class="container">
      <form action="/dataInsertGrupas" method="post" enctype="multipart/form-data"> @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="GrupasNosaukums" placeholder="Ievadiet grupas nosaukumu" required autofocus>
        </div>
        <div class="form-group">
          <label for="Grafiks">Grafiks:</label>
          <input type="text" class="form-control" name="Grafiks" placeholder="Pievienojiet nodarbību grafiku" required autofocus>
        </div>
        <div class="form-group">

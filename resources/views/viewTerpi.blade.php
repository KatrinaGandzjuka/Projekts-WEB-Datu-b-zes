...
<head>
  ...
  <title>Tērpu pārskats | Admins</title>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ url('/redigetTerpi'.$td->KostimiID) }}" class="btn btn-primary">Rediģēt</a></td>
                    <td><a href="{{ url('/dzestTerpus'.$td->KostimiID) }}" class="btn btn-danger">Dzēst</a></td>
                </tr>
                @endforeach
            </tbody>
</table>

...
class PedagogiGrupasController extends Controller
{
    function PievPedPedagogiGrupasIndex($GrupasNosaukums){
        ...
        return view('pievPedPedagogiGrupas', ['GrupasNosaukums'=>$GrupasNosaukums, 'LietotajsData'=> $LietotajsData, 'LomasData'=> $LomasData]);
    }
    ...
    function PedagogiGrupasDataInsert(Request $request, $GrupasNosaukums){
       ...
       $isPedagogiGrupasInsertSuccess = PedagogsGrupa_tabula::insert([
        ...
        if($isPedagogiGrupasInsertSuccess) echo '<script>alert("Pedagogs tika pievienots grupai ;)");</script>';
        else echo '<script>alert("Pedagogs netika pievienots grupai :(");</script>';
